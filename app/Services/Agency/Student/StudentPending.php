...
class StudentPending
{
    public function get(array $queryParams = [])
    {
        ...
        $queryBuilder = ModelsStudent::with(['user:id,name', 'assainuser:id,name', 'source:id,name', 'country:id,name','facebookForm:id,form_name'])->where('status',null)->orderBy('id', 'DESC');
