...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'Payment Voucher Header', href: '/voucherheader/paymentVoucher' }];
...
const onConfirm = async (payment: number) => {
    ...
    deleteForm.put(`/voucherheader/${payment}/status`, {
        onSuccess: () => {},
        onError: () => {
...
<template>
    <Head title="Payment Voucher Header" />
