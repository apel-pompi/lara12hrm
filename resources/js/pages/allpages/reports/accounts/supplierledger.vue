...
const onReport = async () => {
    // ===== VALIDATION =====
    if (!selectedSupplier.value || !selectedSupplier.value.subcode) {
    ...
    // ===== BUILD URL =====
    const url = route('accountsreport.SupplierLedgerReport', {
        branch_id: selectedBranch.value ? selectedBranch.value.id : null,
        supplier: selectedSupplier.value.subcode,
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <AccountsReportsLayout>
            <div class="mx-auto max-w-md space-y-6 rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
                <!-- Title -->
                <h2 class="text-center text-xl font-semibold text-gray-800 dark:text-gray-100">Supplier Ledger Reports</h2>
                <div class="space-y-2">
                    ...
                    <Combobox v-model="selectedSupplier">
                        <div class="relative">
                            <ComboboxInput
                                ...
                                :display-value="(supplier) => supplier?.subcode ?? ''"
