...
const onReport = async () => {
    const url = route('accountsreport.trialbalancereport', {
...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        <Head title="Trial Balance Branch Wise" />
        <AccountsReportsLayout>
            <div class="mx-auto max-w-md space-y-6 rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
                <!-- Title -->
                <h2 class="text-center text-xl font-semibold text-gray-800 dark:text-gray-100">Trial Balance (Branch Wise) Reports</h2>
                <div class="space-y-2">
