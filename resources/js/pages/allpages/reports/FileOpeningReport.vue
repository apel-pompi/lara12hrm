...
const onReport = async () => {
    ...
    const url = route('leadreports.fileopeningReport', {
...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <Head title="File Opening Reports" />
        <LeadReportLayout>
            <div class="mx-auto max-w-md space-y-6 rounded-lg bg-white p-6 shadow-md">
                <!-- Title -->
                <h2 class="text-center text-xl font-semibold text-gray-800">File Opening Reports</h2>
                ...
                <div class="space-y-2">
                    ...
                    <VueDatePicker v-model="formdate" :max-date="maxDate" :format="'yyyy-MM-dd'"
                        :enable-time-picker="false" placeholder="Form Date" auto-apply />
                </div>
                <div class="space-y-2">
                    <Label class="block text-sm font-medium text-gray-700">To Date</Label>
                    <VueDatePicker v-model="todate" :max-date="maxDate" :format="'yyyy-MM-dd'"
                        :enable-time-picker="false" placeholder="Form Date" auto-apply />
                </div>
