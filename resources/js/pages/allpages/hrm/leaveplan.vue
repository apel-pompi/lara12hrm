...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'Leave Plan', href: '/leaveplan' }];
...
const submit = () => {
    const action = isEditMode.value && form.id ? route('leaveplan.update', form.id) : route('leaveplan.store');
            ...
            <div class="border-sidebar-border/70 dark:border-sidebar-border relative min-h-screen flex-1 border bg-gray-50 px-4 py-6 md:min-h-min">
                ...
                <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
                    ...
                    <div class="border-b px-6 py-4">
                        <h2 class="text-lg font-semibold text-gray-800">Leave Plan List</h2>
                        <p class="text-sm text-gray-500">Manage all Leave Plan from here.</p>
                    </div>
                    <Table>
                        <TableHeader>
                    ...
                    <div class="grid grid-cols-2 gap-5">
                        <div class="grid gap-y-3">
                            <div class="grid gap-2">
                                ...
                                <Input class="max-w-sm" placeholder="Enter Leave Name" id="leavename" v-model="form.leavename" autofocus />
                                <span v-if="errors?.leavename" class="text-sm text-red-600">{{ errors.leavename }}</span>
                            </div>
                            <div class="grid gap-2">
                                <Label for="leaveyear">Leave Year</Label>
                                <Input class="max-w-sm" placeholder="Enter Leave Year" id="leaveyear" v-model="form.leaveyear" autofocus />
                                <span v-if="errors?.leaveyear" class="text-sm text-red-600">{{ errors.leaveyear }}</span>
                            </div>

                            <div class="grid gap-2">
                                <Label for="leavedays">Leave Days</Label>
                                <Input class="max-w-sm" placeholder="Enter Leave Days" id="leavedays" v-model="form.leavedays" autofocus />
                                <span v-if="errors?.leavedays" class="text-sm text-red-600">{{ errors.leavedays }}</span>
                            </div>
                        </div>
                        <div class="grid gap-y-3">
                            <div class="grid gap-2">
