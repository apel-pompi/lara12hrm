...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'Designation', href: '/designation' }];
...
const submit = () => {
    const action = isEditMode.value && form.id ? route('designation.update', form.id) : route('designation.store');
            ...
            <div class="border-sidebar-border/70 dark:border-sidebar-border relative min-h-screen flex-1 border bg-gray-50 px-4 py-6 md:min-h-min">
                ...
                <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
                    ...
                    <div class="border-b px-6 py-4">
                        <h2 class="text-lg font-semibold text-gray-800">Designation List</h2>
                        <p class="text-sm text-gray-500">Manage all Designation from here.</p>
                    </div>
                    <Table>
                        <TableHeader>
                    ...
                    <div class="grid gap-5">
                        <div class="grid gap-y-3">
                            <div class="grid gap-2">
                                ...
                                <Input class="max-w-sm" placeholder="Enter Designation Name" id="desname" v-model="form.desname" autofocus />
                                <span v-if="errors?.desname" class="text-sm text-red-600">{{ errors.desname }}</span>
                            </div>
                            <div class="grid gap-2">
            ...
            <Dialog v-model:open="showDialogOpen">
                <DialogContent class="max-w-4xl rounded-2xl p-6 shadow-xl">
                    <DialogHeader>
                        ...
                        <DialogDescription class="text-muted-foreground text-sm"> View the details of this designation. </DialogDescription>
                    </DialogHeader>
