...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'Branch', href: '/branch' }];
...
const submit = () => {
    const action = isEditMode.value && form.id ? route('branch.update', form.id) : route('branch.store');
                    ...
                    <div class="grid grid-cols-2 gap-5">
                        <div class="grid gap-y-3">
                            <div class="grid gap-2">
                                ...
                                <Input class="max-w-sm" placeholder="Enter Branch Name" id="branchname" v-model="form.branchname" autofocus />
                                <span v-if="errors?.branchname" class="text-sm text-red-600">{{ errors.branchname }}</span>
                            </div>
                            <div class="grid gap-2">
                                <Label for="person">Employee Name</Label>
                                <Input class="max-w-sm" placeholder="Enter Employee Name" id="person" v-model="form.person" autofocus />
                                <span v-if="errors?.person" class="text-sm text-red-600">{{ errors.person }}</span>
                            </div>
                            <div class="grid gap-2">
                            ...
                            <div class="grid gap-2">
                                ...
                                <Input class="max-w-sm" placeholder="Enter Phone No" id="phone" v-model="form.phone" autofocus />
                        ...
                        <div class="grid gap-y-3">
                            <div class="grid gap-2">
                                ...
                                <Input class="max-w-sm" placeholder="Enter Designation" id="designation" v-model="form.designation" autofocus />
                                <span v-if="errors?.designation" class="text-sm text-red-600">{{ errors.designation }}</span>
                            </div>
                            <div class="grid gap-2">
                                <Label for="description">Description</Label>
                                <Input class="max-w-sm" placeholder="Enter Description" id="description" v-model="form.description" autofocus />
                                <span v-if="errors?.description" class="text-sm text-red-600">{{ errors.description }}</span>
                            </div>
                            <div class="grid gap-2">
                                <Label for="email">Email</Label>
                                <Input class="max-w-sm" placeholder="Enter email" id="email" v-model="form.email" autofocus />
