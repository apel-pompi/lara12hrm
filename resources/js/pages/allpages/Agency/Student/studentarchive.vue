...
const fetchStudents = async (type: 'name' | 'phone' | 'assain' | 'date', query: string = '') => {
    try {
        const res = await axios.get<Student[]>('/student/SearchArchive', {
            params: { type, q: query },
        });
...
<template>
    <Head title="Student Archive List" />
        ...
        >
            ...
            <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
                ...
                <div class="border-b px-6 py-4">
                    <h2 class="text-lg font-semibold text-gray-800">Archive Student list</h2>
                    <p class="text-sm text-gray-500">Manage all Archive Student from here.</p>
                </div>
