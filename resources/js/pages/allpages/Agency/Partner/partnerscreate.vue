                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:col-span-2 md:grid-cols-2">
                            <div>
                                ...
                                <span v-if="form.errors.master_cat_id" class="text-sm text-red-600">{{ form.errors.master_cat_id }}</span>
                            </div>
                            ...
                            <div>
                                ...
                                <span v-if="form.errors.partner_type_id" class="text-sm text-red-600">{{ form.errors.partner_type_id }}</span>
                            </div>
                            ...
                            <div>
                                ...
                                <span v-if="form.errors.currency" class="text-sm text-red-600">{{ form.errors.currency }}</span>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div class="flex flex-col gap-4 md:flex-row md:space-x-4">
                        ...
                        <div class="w-full md:w-1/3">
                            ...
                            <span v-if="form.errors.country_id" class="text-sm text-red-600">{{ form.errors.country_id }}</span>
                        </div>
                        ...
                        <div class="w-full md:w-1/3">
                            ...
                            <span v-if="form.errors.state_id" class="text-sm text-red-600">{{ form.errors.state_id }}</span>
                        </div>
