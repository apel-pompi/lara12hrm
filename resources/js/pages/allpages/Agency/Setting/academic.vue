            ...
            <div class="border-sidebar-border/70 dark:border-sidebar-border relative min-h-screen flex-1 border bg-gray-50 px-4 py-6 md:min-h-min">
                ...
                <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
                    ...
                    <div class="border-b px-6 py-4">
                        <h2 class="text-lg font-semibold text-gray-800">Academic List</h2>
                        <p class="text-sm text-gray-500">Manage all academic records from here.</p>
                    </div>
                ...
                <DialogContent class="max-w-lg rounded-2xl shadow-lg sm:max-w-xl">
                    ...
                    <DialogHeader class="border-b pb-3">
                        ...
                        <DialogDescription class="text-sm text-gray-500">
                            {{ isEditMode ? 'Update the academic details and click save.' : 'Fill in the details below to create a new academic.' }}
                        </DialogDescription>
                    </DialogHeader>
