...
import { Loader2, Plus, SquarePen, Trash } from 'lucide-vue-next';
                    ...
                    <Table>
                        ...
                        <TableBody>
                            <TableRow v-for="(partnerbranch, index) in props.partnerbranch" :key="partnerbranch.id ?? index">
                                ...
                                <TableCell>
                                    <Switch
                                        v-model="partnerbranch.active"
                                        :checked-value="1"
                                        :unchecked-value="0"
                                        @click="toggleStatus(partnerbranch)"
                                    >
                                    </Switch>
                                </TableCell>
                                <TableCell>{{ partnerbranch.user.name }}</TableCell>
                                <TableCell class="text-right">
                                    <Button class="m-[2px]" size="sm" variant="outline" @click="onEdit(partnerbranch.id)"
                                        ><SquarePen></SquarePen
                                    ></Button>
