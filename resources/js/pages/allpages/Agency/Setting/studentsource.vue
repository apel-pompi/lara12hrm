...
const changePerPage = () => {
    router.get(route('studentSource.index'), { per_page: perPage.value }, { preserveState: false, replace: true });
};
            ...
            <div class="border-sidebar-border/70 dark:border-sidebar-border relative min-h-screen flex-1 border bg-gray-50 px-4 py-6 md:min-h-min">
                ...
                <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
                    ...
                    <div class="border-b px-6 py-4">
                        <h2 class="text-lg font-semibold text-gray-800">Student Acquisition Sources</h2>
                        <p class="text-sm text-gray-500">Manage all student acquisition sources from here.</p>
                    </div>
                    <Table>
                        <TableHeader>
                    ...
                    <div class="flex flex-col gap-4 border-t px-4 py-4 md:flex-row md:items-center md:justify-between">
                        ...
                        <div class="flex flex-col gap-2 text-sm text-gray-600 sm:flex-row sm:items-center">
                            ...
                            <span> Showing {{ studentSource.from }} to {{ studentSource.to }} of {{ studentSource.total }} entries </span>
                        </div>
