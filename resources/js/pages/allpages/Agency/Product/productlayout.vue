...
const updateRate = (status: number) => {
    router.put(
        route('studentActivities.updateRate', props.product.id),
        { 
            ...
            <div class="flex flex-col gap-6 p-4 lg:flex-row">
                ...
                <aside class="flex w-full flex-col gap-6 rounded-xl bg-white p-4 shadow lg:w-1/4 dark:bg-gray-900">
                    ...
                    <div class="flex flex-col items-center border-b pb-5 text-center">
                        <div class="flex h-20 w-20 items-center justify-center rounded-full bg-gray-200 text-xl font-bold dark:bg-gray-700">B</div>
                        <h2 class="mt-2 text-lg font-semibold text-gray-900 dark:text-gray-100">BSC in CSE</h2>
