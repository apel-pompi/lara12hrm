            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900/50">
                    ...
                    <div class="grid grid-cols-2 gap-4 p-5 sm:grid-cols-3">
                        ...
                        <!-- Leave -->
                        <Link
                            :href="route('dashboard.LeaveRequest')"
                        ...
                        >
                            <div class="flex flex-col gap-3">
                                ...
                                <div>
                                    ...
                                    <h4 class="text-xl font-bold text-gray-900 dark:text-white">{{ props.countLeave }}</h4>
                                </div>
                            </div>
                        </Link>
                        ...
                        <!-- Transfer -->
                        <Link
                            :href="route('dashboard.TransferRequest')"
                            class="group rounded-xl border border-gray-100 bg-white p-4 transition-all hover:border-pink-200 hover:bg-pink-50/30 hover:shadow-sm dark:border-gray-800 dark:bg-gray-900 dark:hover:border-pink-900/50 dark:hover:bg-pink-900/10"
                        >
                            <div class="flex flex-col gap-3">
                                <div
                                    class="flex h-10 w-10 items-center justify-center rounded-full bg-pink-100 text-pink-600 dark:bg-pink-900/50 dark:text-pink-400"
                                >
                                    <ArrowRightLeft class="h-5 w-5" />
                                </div>
                                <div>
                                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Transfer</p>
                                    <h4 class="text-xl font-bold text-gray-900 dark:text-white">{{ props.countTransferApproval }}</h4>
                                </div>
                            </div>
                        </Link>
                        ...
                        <!-- onBoard -->
                        <Link
                            :href="route('dashboard.onBoardRequest')"
                            class="group rounded-xl border border-gray-100 bg-white p-4 transition-all hover:border-teal-200 hover:bg-teal-50/30 hover:shadow-sm dark:border-gray-800 dark:bg-gray-900 dark:hover:border-teal-900/50 dark:hover:bg-teal-900/10"
                        >
                            <div class="flex flex-col gap-3">
                                <div
                                    class="flex h-10 w-10 items-center justify-center rounded-full bg-teal-100 text-teal-600 dark:bg-teal-900/50 dark:text-teal-400"
                                >
                                    <Briefcase class="h-5 w-5" />
                                </div>
                                <div>
                                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">OnBoard</p>
                                    <h4 class="text-xl font-bold text-gray-900 dark:text-white">{{ props.countOnBoardApproval }}</h4>
                                </div>
                            </div>
                        </Link>
                        ...
                        <!-- Refund -->
                        <Link
                            :href="route('dashboard.ReturnRequest')"
                            class="group rounded-xl border border-gray-100 bg-white p-4 transition-all hover:border-rose-200 hover:bg-rose-50/30 hover:shadow-sm dark:border-gray-800 dark:bg-gray-900 dark:hover:border-rose-900/50 dark:hover:bg-rose-900/10"
                        >
                            <div class="flex flex-col gap-3">
                                <div
                                    class="flex h-10 w-10 items-center justify-center rounded-full bg-rose-100 text-rose-600 dark:bg-rose-900/50 dark:text-rose-400"
                                >
                                    <HandCoins class="h-5 w-5" />
                                </div>
                                <div>
                                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Refund</p>
                                    <h4 class="text-xl font-bold text-gray-900 dark:text-white">{{ props.countOnRefund }}</h4>
                                </div>
                            </div>
                        </Link>
                    </div>
                ...
                <div class="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900/50">
                    ...
                    >
                        <div class="flex items-center gap-2">
                            ...
                            <h3 class="text-base font-semibold text-white dark:text-gray-100">Attendance Overview</h3>
                        </div>
                    </div>

                    <!-- Stats Cards -->
                    <div class="grid grid-cols-2 gap-4 p-5 sm:grid-cols-2">
                        <!-- Present -->
                        <div
                        ...
                        >
                            <Plane class="mb-2 h-6 w-6 text-purple-600 dark:text-purple-400" />
